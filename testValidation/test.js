...
//   const firstName = fullName.value.split(' ').shift();
//   const lastName = fullName.value.split(' ').pop();
...
//   // check length
//   if (!meetNameLength(firstName, 2, 25)) return true;
// }
...
//   // check length
//   if (!meetNameLength(lastName, 2, 25)) return true;
// }
...
const validateAccountNumber = () => {
  ...
  // if it contains anything but numbers
